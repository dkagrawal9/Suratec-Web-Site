...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
            จัดการใบขาย แบบโอนเงิน
            </h1>
          
            <ol class="breadcrumb">
                <li><a href="../page_home/index.php"></i> Dashboard</a></li>
                <li class="active">จัดการใบขาย แบบโอนเงิน</li>
            </ol>
        </section>
        <!-- Main content -->
...
<br>
                                ...
                                <table class="table table-bordered" id="order_list" width="100%" style="text-align:center;">
                                    ...
                                    $sql = "SELECT *,mod_customer.email as email_cus , mod_order.id_order as id_order ,mod_order_slip.id_order as id_order_slip FROM  mod_order  
                                     ...
                                     WHERE  mod_order.payment = 1 and mod_order.delete_datetime is null
                                    ...
                                    <?php while($res = mysqli_fetch_array($query)){?>
                                            ...
                                            <tr>
                                                ...
                                                <?php
                                                if($res['status'] == 'complete_spending' || $res['status'] == 'complete spending'){ ?>
                                                 <button type="button" name="id_order" id="<?=$res['id_order']?>" class="btn btn-warning  btn-block  confirm_btn"
                                                    data-id="<?=$res['email_cus']?>" 
                                                    fname_to="<?=$res['fname']?>" 
                                                    lname_to="<?=$res['lname']?>" 

                                                    tex_num="<?=$res['tracking_number']?>"
                                                 ><i class="fa fa-check-square-o" aria-hidden="true"></i> Confirm </button>
                                                <?php } ?>
