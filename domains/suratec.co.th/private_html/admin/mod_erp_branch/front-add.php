    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="#">เพิ่มร้านค้า</a></li>
            </ol>
        </section>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <center><h4>เพิ่มบทความเรียบร้อยแล้ว คุณจะไปหน้าจัดการบทความหรือไม่</h4></center>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div style="width: 100%; padding-bottom: 10px;" align="center">
                                        <img id='img-upload' src="img/upload.jpg" style="cursor: pointer;"/>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="box-detail-em">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control " id="name_branch" name="name_branch" placeholder="ชื่อร้านค้า">
                                                </div>
                                            </div>
                                        </div>
                                         <div class="col-md-6">
                                            <div class="box-detail-em">
                                                ที่อยู่
                                                <textarea class="form-control " id="address" name="address" placeholder="ชื่อพนักงาน"> </textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="box-detail-em">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control " id="code_branch" name="code_branch" placeholder="รหัสร้านค้า">
                                                </div>
                                            </div>
                                        </div>
                                         <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="box-detail-em">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-qrcode"></i></span>
                                                    <input type="text" class="form-control " id="no_branch" name="no_branch" placeholder="รหัสสาขา">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="box-detail-em">
                                                อำเภอ
                                                <div class="input-group" style="width: 100%">
                                                    <input type="text" class="form-control " id="amphoe" name="amphoe" placeholder="อำเภอ">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="box-detail-em">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control " id="phone" name="phone" placeholder="หมายเลขโทรศัพท์ 044-471444, 091-00221177">
                                                </div>
                                            </div>
                                        </div>
                                         <div class="col-md-6">
                                            <div class="box-detail-em">
                                                รหัสไปรษณีย์
                                                <div class="input-group" style="width: 100%">
                                                    <input type="text" name="zipcode" class="form-control" id="zipcode" placeholder="รหัสไปรณีย์">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="box-detail-em">
                                                ...
                                                <div class="input-group" style="width: 100%">
                                                    <input type="text" name="taxid" class="form-control" id="taxid" placeholder="เลขประจำตัวผู้เสียภาษี">
                                                </div>
                                            </div>
                                        </div>  
                                    </div>
...
<!--                    <div class="box-header with-border">-->
<!--                        <h3 class="box-title">ระบุโลเคชั่น</h3>-->
<!--                    </div>-->
<!--                </div>-->
    </div>
    <!-- /.box -->
...
<script>
    $(document).ready(function () {
        ...
        //           },
        //           type:'POST',
        //           url:'ajaxData-province.php',
        //           data:'id='+id,
        //           success:function(html){
        //             $('#amphur-beta').html(html);
