...
$strSQL = "SELECT * FROM `freedom_page`";
if (isset($_POST["key_word"])&&$_POST["key_word"] != '') {
  $strSQL .= " WHERE `name_page` LIKE '%".$_POST["key_word"]."%'";
}
              ...
              <thead>
                    <tr>
                     <!--  <th style="text-align: center; min-width:50px; width:50px;"><input class="ClickCheckAll" type="checkbox" name="CheckAll" id="CheckAll" value="Y" onClick="ClickCheckAll(this);"></th>
                      ...
                      <th style="text-align: center; ">ชื่อหน้าเสริม</th>
...
<tr class="show-tr">
             <!--  <td style="text-align: center;">
              ...
              <td  style="text-align: center;">
                  <?php echo $objResult['name_page'] ?> 
              </td>
              <td style="text-align: center;">
               
                    <button style=" <?php echo $button_edit ?>" type="button" class="edit-article btn btn-warning" id="" data-id="<?php echo  $objResult['id_page'] ?>">
                        <i class="fa fa-edit"></i>
                    </button>
                    <button type="button" style=" <?php echo $button_del ?>" class="btn btn-danger delete-article" data-id="<?php echo $objResult['id_page'] ?>"><i class="fa fa-fw fa-trash"></i></button>
    ...
    <?php  }
        $page_query = "SELECT * FROM `freedom_page`";    
        if (isset($_POST["key_word"])&&$_POST["key_word"] != '') {
  $strSQL .= " WHERE `name_page` LIKE '%".$_POST["key_word"]."%'";
}  
