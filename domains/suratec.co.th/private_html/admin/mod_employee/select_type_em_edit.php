                        ...
                        <div class="box box-info box-solid">
                          ...
                          <div class="box-body">
                            <table width="100%">
                              <tbody>                       
<?php
   $str = "SELECT * FROM mod_employee WHERE id_employee = '".$_GET['id_employee_edit']."'";
  $query = mysqli_query($objConnect,$str);
  ...
  $i++;
    $output .= '<tr>
                  ...
                  <td>
                    <div style="float:right">
                      <label><span class="btn btn-default set_authen authen'.$i.' '.$class1.'" data-id="'.$i.'">Manage 
                             <input type="radio" name="general'.$i.'" value="1,'.$objResult["id_system"].'" style="display:none;" '.$check1.'> </span></label>
                      <label><span class="btn btn-default set_authen authen'.$i.' '.$class2.'" data-id="'.$i.'">Write 
                             <input type="radio" name="general'.$i.'" value="2,'.$objResult["id_system"].'" style="display:none;" '.$check2.'> </span></label>
                      <label><span class="btn btn-default set_authen authen'.$i.' '.$class3.'" data-id="'.$i.'">Read 
                             <input type="radio" name="general'.$i.'" value="3,'.$objResult["id_system"].'" style="display:none;" '.$check3.'> </span></label>
                      <label><span class="btn btn-default set_authen authen'.$i.' '.$class0.'" data-id="'.$i.'">Disable 
                             <input type="radio" name="general'.$i.'" value="0,'.$objResult["id_system"].'" style="display:none;" '.$check0.'> </span></label>
                    </div>
                  </td>
                ';    
//---------------------------------------------------------------------------------------sub2-----------------------------------------------------------------------------------------   
  ...
  $output .= '
              <tr>
                  ...
                  <td>
                    <div class="btn-group pull-right">
                      <label><span class="btn btn-default set_authen authen'.$i.' '.$class1.'" data-id="'.$i.'">Manage
                        <input type="radio" name="general'.$i.'" value="1,'.$objResult2["id_system"].'" style="display:none;" '.$check1.'></span></label>
                      <label><span class="btn btn-default set_authen authen'.$i.' '.$class2.'" data-id="'.$i.'">Write
                        <input type="radio" name="general'.$i.'" value="2,'.$objResult2["id_system"].'" style="display:none;" '.$check2.'></span></label>
                      <label><span class="btn btn-default set_authen authen'.$i.' '.$class3.'" data-id="'.$i.'">Read
                        <input type="radio" name="general'.$i.'" value="3,'.$objResult2["id_system"].'" style="display:none;" '.$check3.'></span></label>
                      <label><span class="btn btn-default set_authen authen'.$i.' '.$class0.'" data-id="'.$i.'">Disable
                        <input type="radio" name="general'.$i.'" value="0,'.$objResult2["id_system"].'" style="display:none;" '.$check0.'></span></label>
                    </div>
                  </td>   
    ...
    $output .= '<tr>
             ...
             <div class="form-group" style="padding-left:50px;">
                    ...
                    <td>
                        <div class="btn-group pull-right">
                           <label><span class="btn btn-default set_authen authen'.$i.' '.$class1.'" data-id="'.$i.'">Manage 
                              <input type="radio" name="general'.$i.'" value="1,'.$objResult3["id_system"].'" style="display:none;" '.$check1.'></span></label>
                           <label><span class="btn btn-default set_authen authen'.$i.' '.$class2.'" data-id="'.$i.'">Write 
                              <input type="radio" name="general'.$i.'" value="2,'.$objResult3["id_system"].'" style="display:none;" '.$check2.'></span></label>
                           <label><span class="btn btn-default set_authen authen'.$i.' '.$class3.'" data-id="'.$i.'">Read 
                              <input type="radio" name="general'.$i.'" value="3,'.$objResult3["id_system"].'" style="display:none;" '.$check3.'></span></label>
                           <label><span class="btn btn-default set_authen authen'.$i.' '.$class0.'" data-id="'.$i.'">Disable 
                              <input type="radio" name="general'.$i.'" value="0,'.$objResult3["id_system"].'" style="display:none;" '.$check0.'></span></label>
                        </div> 
                     </td>
                    </tr>   
  ...
  $i++;
    $output .= '<tr>
         ...
         <div class="form-group">
                  ...
                  <td>
                    <div class="btn-group pull-right">
                          <label><span class="btn btn-default set_authen_d authen_d'.$i.' '.$class1.'" data-id="'.$i.'">Manage 
                            <input type="radio" name="system'.$i.'" value="1,'.$objResult["id_system"].'" style="display:none;" '.$check1.'></span></label>
                          <label><span class="btn btn-default set_authen_d authen_d'.$i.' '.$class2.'" data-id="'.$i.'">Write 
                            <input type="radio" name="system'.$i.'" value="2,'.$objResult["id_system"].'" style="display:none;" '.$check2.'></span></label>
                          <label><span class="btn btn-default set_authen_d authen_d'.$i.' '.$class3.'" data-id="'.$i.'">Read 
                            <input type="radio" name="system'.$i.'" value="3,'.$objResult["id_system"].'" style="display:none;" '.$check3.'></span></label>
                          <label><span class="btn btn-default set_authen_d authen_d'.$i.' '.$class0.'" data-id="'.$i.'">Disable 
                            <input type="radio" name="system'.$i.'" value="0,'.$objResult["id_system"].'" style="display:none;" '.$check0.'></span></label>
                    </div>
                  </td>
                </tr>   
                ';      
    ...
    <td>
           <div class="form-group" style="padding-left:25px;">
                  ...
                  <td>
                    <div class="btn-group pull-right">
                      <label><span class="btn btn-default set_authen_d authen_d'.$i.' '.$class1.'" data-id="'.$i.'">Manage 
                        <input type="radio" name="system'.$i.'" value="1,'.$objResult2["id_system"].'" style="display:none;" '.$check1.'></span></label>
                      <label><span class="btn btn-default set_authen_d authen_d'.$i.' '.$class2.'" data-id="'.$i.'">Write 
                        <input type="radio" name="system'.$i.'" value="2,'.$objResult2["id_system"].'" style="display:none;" '.$check2.'></span></label>
                      <label><span class="btn btn-default set_authen_d authen_d'.$i.' '.$class3.'" data-id="'.$i.'">Read 
                        <input type="radio" name="system'.$i.'" value="3,'.$objResult2["id_system"].'" style="display:none;" '.$check3.'></span></label>
                      <label><span class="btn btn-default set_authen_d authen_d'.$i.' '.$class0.'" data-id="'.$i.'">Disable 
                        <input type="radio" name="system'.$i.'" value="0,'.$objResult2["id_system"].'" style="display:none;" '.$check0.'></span></label>
                    </div>
                  </td> 
              </tr> 
                  '; 
      ...
      <td>
             <div class="form-group" style="padding-left:50px;">
                  ...
                  <td>
                    <div class="btn-group pull-right">
                      <label><span class="btn btn-default set_authen_d authen_d'.$i.' '.$class1.'" data-id="'.$i.'">Manage 
                        <input type="radio" name="system'.$i.'" value="1,'.$objResult3["id_system"].'" style="display:none;" '.$check1.'></span></label>
                      <label><span class="btn btn-default set_authen_d authen_d'.$i.' '.$class2.'" data-id="'.$i.'">Write 
                        <input type="radio" name="system'.$i.'" value="2,'.$objResult3["id_system"].'" style="display:none;" '.$check2.'></span></label>
                      <label><span class="btn btn-default set_authen_d authen_d'.$i.' '.$class3.'" data-id="'.$i.'">Read 
                        <input type="radio" name="system'.$i.'" value="3,'.$objResult3["id_system"].'" style="display:none;" '.$check3.'></span></label>
                      <label><span class="btn btn-default set_authen_d authen_d'.$i.' '.$class0.'" data-id="'.$i.'">Disable 
                        <input type="radio" name="system'.$i.'" value="0,'.$objResult3["id_system"].'" style="display:none;" '.$check0.'></span></label>
                    </div>
                  </td>   
                </tr>
                    '; 
