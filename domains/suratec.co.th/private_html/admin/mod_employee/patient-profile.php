...
$strAdd = "SELECT * FROM mod_customer_address WHERE id_customer = '".$_GET['id']."'";
$queryAdd = mysqli_query($objConnect,$strAdd);
$resultAdd = mysqli_fetch_array($queryAdd);

$strUser = "SELECT * FROM tbl_member WHERE id_data_role = '".$_GET['id']."'";
$queryUser = mysqli_query($objConnect,$strUser);
                ...
                <div class="box-body" style="padding-top: 0">
                  <div class="row">
                    ...
                    <div class="col-lg-6" style="margin-top: 10px;">
                      ...
                      <hr>
                      <p>ชื่อ : <font id="name-ex"><?php echo $result['fname']; ?></font><br></p>
                      <p>นามสกุล : <font id="sur-ex"><?php echo $result['lname']; ?></font><br></p>
                      <p>เบอร์โทร : <font id="tel-ex"><?php echo $result['telephone']; ?></font><br></p>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="box-detail-em">
                              ชื่อ <font class="" id="employee-name-text" style="display: none;">*</font>
                              <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input type="text" class="form-control " id="employee-name" name="employee-name" placeholder="ชื่อพนักงาน" value="<?php echo $result['fname'] ?>" <?php echo $input_read; ?>>
                              </div>   
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="box-detail-em">
                              ...
                              <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input type="text" class="form-control " id="employee-sur" name="employee-sur" placeholder="นามสกุล" value="<?php echo $result['lname'] ?>" <?php echo $input_read; ?>>
                              </div>   
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                            <div class="box-detail-em">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control " id="tel" name="tel" placeholder="เบอร์โทรศัพท์" value="<?php echo $result['telephone'] ?>" <?php echo $input_read; ?>>
                              </div>   
                            </div>
                          </div>
...
<input type="text" class="form-control " id="address" name="address" value="<?=$resultAdd['address'] ?>"  placeholder="ที่อยู่">
                                </div>   
                              </div>
                            </div>
                            ...
                            <div class="col-md-6">
                              <div class="box-detail-em">
                                ...
                                <div class="input-group">
                                  <span class="input-group-addon"><i class="fa fa-address-book-o"></i></span>
                                  <input class="form-control" type="text" name="amphures" id="amphures" value="<?=$resultAdd['amphur'] ?>" placeholder="อำเภอ">
                                </div>   
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="box-detail-em">
                                ...
                                <div class="input-group">
                                  <span class="input-group-addon"><i class="fa fa-address-book-o"></i></span>
                                  <input class="form-control" type="text" name="district" id="district" value="<?=$resultAdd['district'] ?>" placeholder="ตำบล">
                                </div>   
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="box-detail-em">
                                ...
                                <div class="input-group">
                                  <span class="input-group-addon"><i class="fa fa-address-book-o"></i></span>
                                  <input class="form-control" type="text" name="province" id="province" value="<?=$resultAdd['province'] ?>" placeholder="จังหวัด">
                                </div>   
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="box-detail-em">
                                ...
                                <div class="input-group">
                                  <span class="input-group-addon"><i class="fa fa-address-book-o"></i></span>
                                  <input class="form-control" type="text" name="zip_code" id="zip_code" value="<?=$resultAdd['postalcode'] ?>" placeholder="รหัสไปรษณีย์">
                                </div>   
                              </div>
                            </div>
                    ...
                    <div class="box-detail-em" style="padding-bottom: 0">
                      <p>ชื่อผู้ใช้งาน  <font class="" id="employee-user-text" style="display: none;">*</font>
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control " id="employee-user" name="employee-user" placeholder="ชื่อผู้ใช้งานสำหรับเข้าสู่ระบบ" value="<?php echo $resultUser['user_member'] ?>" <?php echo $input_read; ?>>
                        </div>  
                      </div>
