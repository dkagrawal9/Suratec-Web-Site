...
<!-- start form -->
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control"  name="Tax_ID" id="Tax_ID" value="<?php echo $result['tax_id']; ?>">
                                                </div>
                                            </div>
                                         </div>
                                    </div>
           ...
           <!--  <br>  --> 
            <!-- Start box warning for ADD system -->
                    <div class="box box-primary box-solid">
                        <div class="box-header with-border">
                            <div class="col-md-6">
                                <h3 class="box-title">ที่อยู่ลูกค้า</h3>
                            </div> 
 ...
 <?php 
 $str_add = "SELECT * FROM mod_customer_address WHERE    id_customer = '".$_GET['id']."' AND (delete_datetime IS NULL OR delete_datetime ='0000-00-00 00:00:00')";


    $query_add = mysqli_query($objConnect,$str_add);
    while($result_add = mysqli_fetch_array($query_add)){
        ?>
        <tr>
            
            <td><?php echo $result_add["fname"] ?> <?php echo $result_add["lname"] ?></td>
            <td><?php echo $result_add["address"] ?> <?php echo $result_add["district"] ?></td>
            <td><?php echo $result_add["amphur"] ?> <?php echo $result_add["province"] ?>  <?php echo $result_add["postalcode"] ?></td>
