...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="../page_home/index.php"></i> Dashboard</a></li>
                 <li><a href="front-manage.php"></i> จัดการลูกค้า</a></li>
        ...
        <div class="boxsave">
            <button type="button" class="btn btn-primary pull-right btnSendAdd" id="open-add" style="transition: 0.4s; margin-left: 5px; <?php echo $button_open ?>"><i class="fa fa-clone"></i>&nbsp;New Address</button>
                        ...
                        <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary" id="btnSend-new">Save</button>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
                            </div>
            ...
            var input_read = $('#per_input_read').val();
             ...
             var table = $('#table').DataTable( {
                ...
                "columns": [
                    ...
                    // { "data": "status" },
                    { "defaultContent": "" +
                        "<button style='"+button_edit+"' class='btn btn-warning btn-sm edit'>แก้ไข</button>" +
                        "<button style='"+button_del+"' class='btn btn-danger btn-sm delete'>ลบที่อยู่</button>" +
