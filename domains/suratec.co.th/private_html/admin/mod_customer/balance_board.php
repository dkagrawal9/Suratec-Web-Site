                  ...
                  <ul>
                    ...
                    <li><a href="javascript:newDasboard()" ><img src="../../img/bg-img/ui.png"> Dasboard</a></li>  
                            ...
                            <div class="col-md-8">
                              <div class="box box-success box-solid">
                                 <div class="box-header with-border">
                                    <h3 class="box-title">Balance Board</h3>
                                </div>
                                <div class="box-body" >
                                    <div class="form-horizontal">
                                        <div class="box-body">
...
<div class="col-md-12" style="text-align: center;" align="center">
              ...
              <div class="col-md-12" >
                <div class="row">
                   <h3 align="center">Time in Zone  <font id="p_time"> 0 s </font></h3> 
                  <div class="col-md-6">
                ...
                <table class="table" border="1">
                    <tr>
                      <th style="background: #cccccc;">คะแนนการทรงตัว</th>
                      <th style="background: #cccccc;">การทรงตัว</th>
                    </tr>
                    <tr>
...
function function_play() {
  ...
  $.redirect("balance_board.php?id_customer="+id_customer, {playback_type: playback_type, datetimepicker: datetimepicker, playback_time: playback_time, status_play: '1'}, "POST", ""); 
}
