...
<html lang="en">
   ...
   <div id="s-wrapper" class="s-wrapper">
                     ...
                     <div class="s-phase-two-box" style="font-size:16px">
                        <div class="s-phase-item" style="width: 49%;">
                           <p class="s-phase-title">สรุป Peak Pressure ซ้าย</p>
                              <div class="col-md-12">
                                <table class="table table-striped" border="1" style="padding: 0px !important;">
                                  <thead>
                                    <tr>
                                    <th>Zone</th>
                                        <th>AVG</th>
      ...
      <input type="hidden" name="playback_time" id="playback_time" value="<?php echo $playback_time ?>">
...
$("#p_heal_avg_right").html(avg_sensor4_right_kpa);
          ...
          if (id_customer != '' && playback_type != '0' && datetimepicker!= '') {
             $.ajax({   
                      url:'report_test_time_new.php?id_customer='+id_customer, 
                      method:'POST',  
...
$("#p_heal_avg_right").html('0');
         ...
         height = $("#height").val(); 
         if (sex == '0') {
         distance = parseInt(height * 0.415) * (step_count/2)
         }else{
         distance = parseInt(height * 0.413) * (step_count/2)
         }
         distance_km = (distance/100000).toFixed(2);
         $("#span_distance").html(distance_km+' km.'); 
         if (new_sec=='0') {
         ...
         $('#rs2_avg').text(avg_peak_r2_kpa);  
         $('#rs3_avg').text(avg_peak_r3_kpa);  
         ...
         $('#rs2_max').text(max_peak_r2_kpa);  
         $('#rs3_max').text(max_peak_r3_kpa);  
