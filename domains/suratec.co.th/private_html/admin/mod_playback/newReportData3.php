   ...
   <body>
    ...
    //    }
       function function_play() {
         ...
         $.redirect("newReportData3.php?id_customer="+id_customer, {playback_type: playback_type, datetimepicker: datetimepicker, playback_time: playback_time, status_play: '1',upload_csv:files}, "POST", ""); 
       } 
...
var subject_count_left = [];
var subject_count_right = [];
var new_x = [];
var new_y = [];
var step_count = 0;
var walking_speed = 0;
...
column31.forEach(function(row1, ival) {
    ...
    if (column31[ival] < 0 && column31[ival + 1] >= 0) {
        subject_count_left.push(ival)
    }
    if (column32[ival] < 0 && column32[ival + 1] >= 0) {
        subject_count_right.push(ival)
    }
});
subject_count_left.push(foreL.length-1);
console.log(foreL.length,"***Length***");
console.log(subject_count_left,"****IVAL*Left***");

//console.log(subject_count_right,"****IVAL*Right***");
console.log(foreL,"****Raw Data****");
...
for (var i = 0; i < subject_count_left.length - 1; i++) {
    foreL_min_temp = 999;
    midL_min_temp = 999;
    heelL_min_temp = 999;
    foreR_min_temp = 999;
    midR_min_temp = 999;
    heelR_min_temp = 999;
    for (var j = subject_count_left[i]; j < subject_count_left[i + 1]; j++) {
...
console.log(foreL_min,"***Minimium***");
subject_count_left[0] = 0;
subject_count_left[subject_count_left.length - 1] = foreL.length - 1;
var count_min = 0;
