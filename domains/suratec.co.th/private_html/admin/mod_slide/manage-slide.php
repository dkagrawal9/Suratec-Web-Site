                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="thai">
                                        <div class="input-group">
                                            ...
                                            <input type="" name="name" class="form-control" placeholder="ชื่อหัวข้อ TH" id="name" onkeyup="checklength();">
                                        </div>
                                        <div style="padding: 10px 0px 7px 0px;">
                                            <label>เนื้อหา</label>
                                            <textarea class="form-control edit" rows="5" style="resize: none;" name="content_slide" placeholder="เนื้อหา ภาษาไทยสไลด์สำหรับแสดงหน้าภาพสไลด์......"></textarea>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="english">
                                        <!-- <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-header"></i></span>
                                            <input type="" name="head_slide_en" class="form-control" placeholder="หัวข้อ ภาษาอังกฤษ" id="txt" onkeyup="checklength();">
                                        </div> -->
                                        <div class="input-group">
                                            <span class="input-group-addon">ชื่อหัวข้อ</span>
                                            <input type="" name="name_en" class="form-control" placeholder="ชื่อหัวข้อ EN" id="name_en" onkeyup="checklength();">
                                        </div>
                                        <div style="padding: 10px 0px 7px 0px;">
                                            <label>เนื้อหา</label>
                                            <textarea class="form-control edit" rows="5" style="resize: none;" name="content_slide_en" placeholder="เนื้อหาสไลด์ ภาษาอังกฤษสำหรับแสดงหน้าภาพสไลด์......"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
