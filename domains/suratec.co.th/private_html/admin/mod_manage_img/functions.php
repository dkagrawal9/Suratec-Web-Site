...
if (isset($_POST['_method'])) {
    ...
    delmulti();
    exit;
	}elseif ($_POST['_method'] == 'CREATE_type') {
    CREATE_type();
    exit;
	}elseif ($_POST['_method'] == 'edit_type') {
    edit_type();
    exit;
	}elseif ($_POST['_method'] == 'del_type') {
    del_type();
    exit;
	}
...
global $date;
	...
	$sql = "DELETE FROM `image_category` WHERE `id_catagory`='".$_POST["id"]."'";
...
$strSQL = "UPDATE `image_category` SET `name_catagory`='".$_POST['name']."',`date_catagory`='".$date."' WHERE `id_catagory`='".$_POST['id_catagory']."'";
...
$strSQL = "INSERT INTO `image_category`( `name_catagory`,  `date_catagory`) VALUES ('".$_POST['name']."','".$date."')";
