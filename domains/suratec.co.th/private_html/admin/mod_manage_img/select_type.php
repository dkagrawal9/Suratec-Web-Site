...
$input_read   = $_POST["input_read"];
 ...
 <div class="modal-body">
          ...
          <input type="hidden" name="_method" id="_method" value="CREATE_type">
...
<button style="<?php echo $button_edit ?>" type="button" class="btn btn-warning" id="btnEdit_icon" data-id="<?php echo $result["id_catagory"] ?>"  >
                        <i class="fa fa-edit"></i>
 </button>

<!--  <button style="<?php echo $input_read ?>" type="button" class="btn btn-info" id="btn_show_type" data-id="<?php echo $result["id_catagory"] ?>"  >
                        <i class="fa fa-fw fa-eye"></i>
 </button>
 -->
<button type="button" style="<?php echo $button_del ?> "  class="delete-type btn btn-danger" data-id= "<?php echo $result["id_catagory"] ?>"><i class="fa fa-fw fa-trash"></i></button>
...
$button_open   = $_POST["button_open"];
$input_read   = $_POST["input_read"];
    $str1 = "SELECT `id_catagory`,`name_catagory` FROM `image_category` WHERE `id_catagory`= '".$_POST["id_edit"]."'";
    $query1 = mysqli_query($objConnect,$str1);
    $result1 = mysqli_fetch_array($query1);
?>
<form action="" method="post" id="frm_edit_type">
          <input type="hidden" name="_method" id="_method" value="edit_type">
                                    ...
                                    <div class="form-horizontal">
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control"  name="name" id="name" value="<?php echo $result1["name_catagory"] ?>">
                                                    <input type="hidden" class="form-control"  name="id_catagory" id="id_catagory" value="<?php echo $result1["id_catagory"] ?>">
                                                </div>
                                            </div>
