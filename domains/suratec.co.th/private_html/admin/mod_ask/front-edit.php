  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
      ...
      <div class="modal fade" id="modal-default">
        ...
        <!-- /.modal -->
        <?php 
           $strSQL = "SELECT * FROM `page` WHERE id ='".$_GET['id']."'";
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="box box-info">
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="thai">
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control " id="article_name" name="name" value="<?php echo $objResult["name"]; ?>" onkeyup="checklength()">
                  </div></div>
                 
                    <div class="input-group">
                    <span class="input-group-addon">ลิงค์</span>
                    <input type="text" class="form-control " id="link" name="link" value="<?php echo $objResult["url"]; ?>" >
                  </div>
                  <!-- <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-header"></i></span>
                    <input type="text" class="form-control " id="article_name" name="name" value="<?php echo $objResult["name_article"]; ?>" onkeyup="checklength()">
                  </div> -->
                  <input type="hidden" name="id_link" value="3">
                  <div id="editor" style="margin-top: 10px;">
                    <textarea class='edit' name="editor" style="margin-top: 20px;"><?php echo $objResult["data"]; ?></textarea>
                  </div>
                </div>
                <!-- <div class="tab-pane" id="english">
                  <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-header"></i></span>
                    <input type="text" class="form-control " id="article_name_en" name="article_name_en" placeholder="<?=lang('ภาษาอังกฤษ','English')?>" value="<?php echo $objResult["name_article_en"]; ?>" onkeyup="checklength()">
                  </div>
                  <input type="hidden" name="id_link" value="3">
                  <div id="editor" style="margin-top: 10px;">
              ...
              <input type="hidden" name="id" id="id" value="<?php echo $objResult["id"]; ?>" >
            </div>
            </div>
            <!-- /.box -->
          </div>
