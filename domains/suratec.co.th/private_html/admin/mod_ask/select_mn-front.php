...
$strSQL = "SELECT * FROM `page`";
if (isset($_POST["key_word"])&&$_POST["key_word"] != '') {
  $strSQL .= " WHERE `name` LIKE '%".$_POST["key_word"]."%'";
}
...
<tr class="show-tr">
             <!--  <td style="text-align: center;">
              ...
              <td style="text-align: center;">
                    ...
                    <button style="background-color: white; <?php echo $button_edit ?>" type="button" class="edit-article btn btn-default" id="" data-id="<?php echo  $objResult['id'] ?>">
                        <i class="fa fa-edit"></i>
                    </button>
                  <!--   <button type="button" class="btn btn-default delete-article" data-id="'.$objResult['id_article'].'"><i class="fa fa-remove"></i></button> -->
