  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         ...
         <input type="hidden" name="page_titel" id="page_titel" value="ข่าวสาร">
        เพิ่มข่าวสาร
      </h1>
      <ol class="breadcrumb">
      ...
      <div class="modal fade" id="modal-default">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <center><h4><?=lang('เพิ่มข่าวสารเรียบร้อยแล้ว คุณจะไปหน้าจัดการข่าวสารหรือไม่','Added article successfully Will you go to the article management page?')?></h4></center>
              </div>
        ...
        <div class="row">
            ...
            <div class="nav-tabs-custom">
              ...
              <div class="box-header with-border">
                <h3 class="box-title"><?=lang('หมวดหมู่ข่าวสาร','Catagory')?></h3><button type="button" class="btn btn-default btn-xs pull-right" onclick="javascript:location.href='front-catagory.php'"><?=lang('จัดการหมวดหมู่','Manage categories')?></button>
              </div>
              <div class="box-body">
                <div id="catagory"></div>
              </div>
