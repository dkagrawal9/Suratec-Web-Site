...
@$output .= '
            ...
            <input type="hidden" name="level_modal" id="id" value="'.$level. '">
                ...
                <div class="nav-tabs-custom" style="box-shadow:none; margin-bottom:0px;">
                  ...
                  <div class="tab-content" style="padding: 5px 15px 5px 15px; margin-top: 5px;">
                    <div class="tab-pane active" id="thai_modal">
                      ...
                      <input type="text" class="form-control" placeholder="ภาษาไทย" name="name" id="name_modal" required="required" value="' .$name.'" onkeyup="checklengthEdit()" readonly/>
                    </div>
              ...
              if($level == '1'){
                ...
                $sltd = 'จัดเป็นหมวดหมู่หลัก';
              }else {

              $Choice1 = "SELECT * FROM product_catagory WHERE id_catagory = $id_menu";
              $queryChoice1 = mysqli_query($objConnect,$Choice1);          
              $resultChoice1 = mysqli_fetch_array($queryChoice1);

                $sltd = $resultChoice1["name_catagory"];
              }
$output .= '                  
            ...
            <input type="text" class="form-control"  name="name" id="name_modal" required="required" value="' .$sltd.'"  readonly/>
