        ...
        <section class="content">
            ...
            <div class="box box-info">
              ...
              <div class="tab-content">
                ...
                <div class="input-group" style="margin-bottom: 0;">
                  ...
                  <input type="text" class="form-control" id="name_product" name="name_product" placeholder="ชื่อสินค้า" value="<?php echo  $result['name_product'] ?>" onkeyup="checklength()" readonly>
                </div>
              </div>
   
   
                  <div id="editor" style="margin-top: 10px; height: 250px; overflow: auto;">
                    <?php echo  $result['detail_product'] ?>
                  </div>
                </div>
                ...
                <div class="input-group" style="margin-bottom: 0;">
                  <span class="input-group-addon"><i class="fa fa-header"></i></span>
                  <input type="text" class="form-control" id="product_name_en" name="product_name_en" placeholder="ชื่อสินค้า" value="<?php echo  $result['name_product_en'] ?>" readonly>
                </div>
              </div>
              
                  <div id="editor" style="margin-top: 10px;height: 250px; overflow: auto;">
                   <?php echo  $result['detail_product_en'] ?>
                  </div>
                </div>
                ...
                <div class="input-group" style="margin-bottom: 0;">
                  <span class="input-group-addon"><i class="fa fa-header"></i></span>
                  <input type="text" class="form-control" id="product_name_ch" name="product_name_ch" placeholder="ชื่อสินค้า" value="<?php echo  $result['name_product_ch'] ?>" readonly>
                </div>
              </div>
                  <div id="editor" style="margin-top: 10px;height: 250px; overflow: auto;">
                    <?php echo  $result['detail_product_ch'] ?>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="box box-info">
              ...
              <div class="tab-content">
                ...
                <div class="input-group" style="margin-bottom: 0;">
                  ...
                  <div id="editor" style="margin-top: 10px;max-height: 250px;" class="div_reviwe">
                    <?php echo  $result['review_product'] ?>
                ...
                <div class="input-group" style="margin-bottom: 0;">
                  ...
                  <div id="editor" style="margin-top: 10px;max-height: 250px;" class="div_reviwe">
                    <?php echo  $result['review_product_en'] ?>
                ...
                <div class="input-group" style="margin-bottom: 0;">
                  ...
                  <div id="editor" style="margin-top: 10px;max-height: 250px;" class="div_reviwe">
                    <?php echo  $result['review_product_ch'] ?>
         ...
         <div class="col-md-12">
                <div class="box box-default">
                      ...
                      <?php     $str_image_product = "SELECT * FROM `product_image` WHERE `id_product` = '" . $result['id_product'] . "'";
                                                        $query_image_attr = mysqli_query($objConnect , $str_image_product);
                                                        while ($result_image_product = mysqli_fetch_array($query_image_attr) ) {
                                                            
                                                        
                                                        if ($result_image_product['name_image'] != '') {
                                                            $image = '../../uploads/product/' . $result_image_product['name_image'];
                                                        } else {
                                                            $image = 'https://www.igetweb.com/themes_v2/assets/img/default-img.png';
                                                        } ?>
                                                         <img style="width: 200PX; padding: 20px" src="<?php echo $image ?>"  >
                                                         <?php } ?>
                        </div>
                            ...
                            <div id="printableTable">
                               <!-- <div class="box-body">
                                ...
                                <div class="box-body">
                                        ...
                                        <div class='col-sm-10' id='datetimepicker'>
                                            <input type='text' class="form-control"  name="SKU" id="SKU" value="<?php echo $result['sku']; ?>" readonly>
                                        </div>
                                </div>
                                <div class="box-body">
                                        <label class="col-sm-2 control-label">ราคาขาย</label>
                                        <div class='col-sm-10' id='datetimepicker'>
                                            <input type='number' class="form-control"  name="selling_price" id="selling_price" value="<?php echo $result['tmp_price']; ?>" readonly>
                                        </div>
                                </div>
                                <div class="box-body">
                                        <label class="col-sm-2 control-label">ราคาทุน</label>
                                        <div class='col-sm-10' id='datetimepicker'>
                                            <input type='number' class="form-control"  name="capital_cost" id="capital_cost" value="<?php echo $result['cost']; ?>" readonly>
                                        </div>
                                </div>
                                <div class="box-body">
                                        <label class="col-sm-2 control-label">น้ำหนักสินค้า(g)</label>
                                        <div class='col-sm-10' id='datetimepicker'>
                                            <input type='number' class="form-control"  name="weight" id="weight" value="<?php echo $result['weight']; ?>" readonly>
                                        </div>
                                </div>
                                <div class="box-body">
                                        ...
                                        <div class='col-sm-10' id='datetimepicker'>
                                            <input type='' class="form-control"  name="" id="" value="<?php echo $result["mod_name_branch"] ?>" readonly>
                                        </div>
...
$str_check_attr = "SELECT * FROM product_attribute WHERE id_product = '" . $_GET['id'] . "' AND`delete_datetime` IS null";
    ...
    $result_check_attr = mysqli_fetch_array($query_check_attr);
                            ...
                            ?>
                                        ...
                                        <div class="sticky-table empty">
                                                ...
                                                <table id="table-multiple-variant" class="table table-hover table-list">
                                                    ...
                                                    while ( $result_attr_cobi = mysqli_fetch_array($query_attr_cobi) ) {
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <label>
                                                                    <img src="<?php echo $image; ?>" class="variant-img<?php echo $a; ?> item-list-img default-img" style="width:40px; cursor:pointer;" readonly>
                                                                    <input type="file" class="image_upload" data-id="<?php echo $a; ?>" style="display:none;" name="attr_file_ex[]" readonly></label>
                                                            </td>
                                                            <td>
                                                                <?php
                                                                ...
                                                                <input type="hidden" value="<?php echo $result_attr_cobi['option_name']; ?>" name="option_attr_ex[]" id="option_attr<?php echo $a; ?>" readonly>
                                                                <input type="hidden" name="attr_head_ex[]" value="<?php echo $result_attr_cobi['attribute_name']; ?>" class="id_attr_head" readonly>
                                                                <input type="hidden" name="id_attr[]" value="<?php echo $result_attr_cobi['id_attr']; ?>" class="" readonly>
                                                            </td>
                                                            <td>
                                                                <div class="input-group input-group-sm">
                                                                    <input type="text" name="price_ex[]" value="<?php echo $result_attr_cobi['price_attr']; ?>" class="form-control" readonly>
                                                                    <span class="input-group-addon" style="padding:5px;">THB</span>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="input-group input-group-sm">
                                                                    <input type="text" name="normal_ex[]" value="<?php echo $result_attr_cobi['price_n_attr']; ?>" class="form-control" readonly>
                                                                    <span class="input-group-addon" style="padding:5px;">THB</span>
                                                                </div>
                                                            </td>
                                                            <td>
                                          ...
                                          <input name="stock_ex[]" type="text" readonly class="form-control input-sm" value="<?php echo $result_attr_cobi['sum_stock']; ?>" style="max-width:45px; padding-left:0; padding-right:0;">
                                                            ...
                                                            <td>
                                                                <div class="input-group input-group-sm">
                                                                    <input name="weight_ex[]" type="text" value="<?php echo $result_attr_cobi['weight_attr']; ?>" class="form-control"readonly>
                ...
                <div class="boxsave">
                    <a href="front-manage.php" class="btn btn-default pull-right "><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp;ย้อนกลับ</a>
