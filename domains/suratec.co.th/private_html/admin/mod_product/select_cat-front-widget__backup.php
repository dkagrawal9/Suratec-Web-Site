...
$strSQL = "SELECT * FROM product_catagory WHERE level = '1' AND id_catagory NOT IN('187','188','223')";
...
$output .= '
    ...
    $Choice1 = "SELECT * FROM product_catagory WHERE level = '1' AND id_catagory NOT IN('187','188','223')";
    ...
    $output .= ' </select>
        ...
        <div class="box-tr'.$objResult['id_catagory'].'" style="border:none; display:none;">'; 
