    ...
    <section class="content-header">
     <h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">จัดการคุณลักษณะสินค้า</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      ...
      <div class="box box-info">
        <div class="box-header">
          <h3 class="box-title">จัดการคุณลักษณะ</h3>
        </div>
      ...
      <div class="boxsave">
            <button type="button" class="delmulti-menu btn btn-danger" style="transition: 0.4s; <?php echo $button_del_s; ?>" id="MultiDelete" disabled><i class="fa fa-remove"></i> ลบรายการที่เลือก <span class="num_"></span></button>
            ...
            <button type="button" class="btn btn-success" style="transition: 0.4s; <?php echo $button_open ?>" id="Add-attribute"><i class="fa fa-plus"></i> เพิ่มคุณลักษณะ </button>
            </form>
      </div>
