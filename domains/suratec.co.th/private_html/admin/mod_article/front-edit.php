          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <center><h4><?=lang('แก้ไขบทความเรียบร้อยแล้ว คุณจะไปหน้าจัดการบทความหรือไม่','Added article successfully Will you go to the article management page?')?></h4></center>
              </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="box box-warning box-solid">
                                <div class="box-header with-border">
                                    <h3 class="box-title">แก้ไขบทความ</h3>
                                </div>
                                <div class="box-body" >
