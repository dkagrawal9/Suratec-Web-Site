             ...
             <div class="panel-body">
                        <form id="frm_search">
                            ...
                            <div class="form-group" >
                                <div class="col-md-6">
<?php
$strSQL = "SELECT `name_article` FROM `article` WHERE `id_article` ='".$_GET["id"]."' "; 
$objQuery = mysqli_query($objConnect,$strSQL) or die (mysqli_error());
$objResult = mysqli_fetch_array($objQuery);
?>
                                    <h3><?php echo $objResult["name_article"] ?></h3> 

                                </div>
                                <div class="col-md-6 ">
                                    <input type="text" class="form-control" name="key_word" id="key_word" placeholder="<?=lang('ค้นหา', 'Search')?>" onkeyup="myFunction()">
...
function myFunction(){
     ...
     $.ajax({  
                  url:"select_mn-front_opinion.php?id="+id,  
                  method:"POST",  
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '.btnSendDel', function(){
            $.ajax({
                ...
                type:"POST",
                url:'back_article-delete_opinion.php',
