						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-6 col-12">
								...
								<div class="single-widget links" style="margin-top: 10px;">
									...
									<ul class="list">
										<li><a href="../home/terms_of_use.php?terms_of_use=st"><i class="fa fa-caret-right"></i>
												<?php
												if($lang_file == 'lang.th.php'){
										...
										<li><a href="../home/privacy_policy.php?privacy_policy=st"><i class="fa fa-caret-right"></i>
												<?php
												if($lang_file == 'lang.th.php'){
										...
										<li><a href="../home/data_protection_policy.php?data_protection_policy=st"><i class="fa fa-caret-right"></i>
												<?php
												if($lang_file == 'lang.th.php'){
										...
										<li><a href="../home/refund_policy.php?refund_policy=st"><i class="fa fa-caret-right"></i>
												<?php
												if($lang_file == 'lang.th.php'){
							...
							<div class="col-lg-3 col-md-6 col-12">
								...
								<div class="single-widget posts" style="margin-top: 10px;">
									...
									<ul>
										<li><a href="../home/article.php"><img src="../images/seo-article-icon.png" alt="#"><?=$lang['MENU_Article']?><!--Article--></a></li>
										<li><a href="../home/news.php"><img src="../images/news_logo.png" alt="#"><?=$lang['MENU_News']?><!--News--></a></li>
									</ul>
								</div>
								<!--/ End Posts Widget -->
							</div>
							<div class="col-lg-3 col-md-6 col-12">
								...
								<div class="single-widget about" style="margin-top: 10px;">
									...
									<ul class="list">
										<li><?php
												if($lang_file == 'lang.th.php'){
													$name_text = $titel['value'];
													echo $name_text;
												}
												 else{
													 $name_text_en = $titel_en['value'];
													echo $name_text_en;
												 }
												?></li>
									</ul>
