					...
					<div class="row">
						<div class="col-12">
							...
							<div class="bread-title">
								<h2><?=$lang['MENU_News'];?><!--Our Team--></h2>
							</div>
							<!-- Bread List -->
							<ul class="bread-list">
								<li><a href="./?index=st"><i class="fa fa-home"></i><?=$lang['MENU_HOME'];?><!--Home--></a></li>
								<li class="active"><a href="news.php"><i class="fa fa-clone"></i> <?=$lang['MENU_News'];?> <!--Our Team--></a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							...
							<div class="single-blog">
								...
								<div class="blog-bottom">
									<h4><a href="./newsdetail.php?id=<?=$data['id_article'];?>">
												<?php
									...
									<p>
												...
												if($lang_file == 'lang.th.php'){
													$name_text = $data['text'];
													echo substr_replace($name_text, '...' ,524);
												}
												 else{
													 $name_text_en = $data['text_en'];
													echo substr_replace($name_text_en, '...' ,524);
												 }
												?></p>
									<ul class="blog-meta">
