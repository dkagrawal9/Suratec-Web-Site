					...
					<div class="row">
						<div class="col-12">
							...
							<div class="bread-title">
								<h2><?=$lang['MENU_article_details'];?><!--Our Team--></h2>
							</div>
							<!-- Bread List -->
							<ul class="bread-list">
								<li><a href="./?index=st"><i class="fa fa-home"></i><?=$lang['MENU_HOME'];?><!--Home--></a></li>
								<li class="active"><a href="articledetail.php?id=<?=$resultnews['id_article'];?>"><i class="fa fa-clone"></i> <?=$lang['MENU_article_details'];?> <!--Our Team--></a></li>
							</ul>
						</div>
					</div>
				</div>
								...
								<div class="col-12">
									...
									<div class="single-blog">
										...
										<div class="blog-description">
											<h1><a href="articledetail.php?id=<?=$resultnews['id_article'];?>"><?php
												if($lang_file == 'lang.th.php'){
													$name_text = $resultnews['name_article'];
													echo $name_text;
												}
...
class="fb-xfbml-parse-ignore"><?=$lang['MENU_share'];?>
</a></div>
...
?>
											<h2><?=$rows?> <?=$lang['MENU_c_reviews'];?> <!--(2)--></h2>
										</div>
									...
									" alt="#"/>
												...
												?>
													<div class="body">
														...
														<p><?php
												if($lang_file == 'lang.th.php'){
													$name_text = $comnews['message'];
													echo $name_text;
												}
												 else{
													 $name_text_en = $comnews['message'];
													echo $name_text_en;
												 }
												?></p>
