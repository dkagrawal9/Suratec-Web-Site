                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-12">
												...
												<?php if($lang_file == 'lang.th.php'){
                                                    ...
                                                    <p>
													<?php if($lang_file == 'lang.th.php'){
													$name_text = $objResult['detail_product'];
													echo $name_text;
												}
												 else{
													 $name_text_en = $objResult['detail_product_en'];
													echo $name_text_en;
												 } ?></p>
													<?php $i=1; ?>
													<?php if (isset($_SESSION["id_customer"])) { ?>
													<button onclick="add_Cart('<?=$objResult['id_product']; ?>','<?=$objResult['tmp_price']; ?>','<?=$objResult['tmp_price']; ?>');" type="submit" class="btn"><i class="fa fa-shopping-basket"></i><?=$lang['MENU_atc'];?><!--Add to cart--></button>
													<?php } else { ?>
...
<div class="row">
...
} ?> class="prev"><a style="" onclick="searchpage(<?php echo '1' ?>);"><i class="fa fa-angle-double-left"></i></a></li>
    ...
    echo 'class="page-link"';
                ...
                <li <?php  if ($count <= 1) {
                    ...
                    echo 'class="page-item"';
                } ?>><a style="" onclick="searchpage(<?php echo $total_page ?>);"><i class="fa fa-angle-double-right"></i></a></li>
                                </ul>
                            </div>
                            <!--/ End Pagination -->
                        </div>
