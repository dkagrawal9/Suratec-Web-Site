        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="bread-title">
                    <h2><?=$lang['MENU_Shop_cart'];?><!--About Us--></h2>
                </div>
                <!-- Bread List -->
                <ul class="bread-list">
                    <li><a href="./?index=st"><i class="fa fa-home"></i><?= $lang['MENU_HOME']; ?><!--Home--></a></li>
                    <li class="active"><a href="about_us.php?about_us=st"><i class="fa fa-clone"></i><?=$lang['MENU_Shop_cart'];?><!--About Us--></a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    //   alert(cok[1])
         if(cok != ''){
            ...
            var xmlhttp = new XMLHttpRequest();
                    ...
                    xmlhttp.open("GET", "live-order_no_data.php", true);
                    xmlhttp.send();
         }
	}
    //var table;
