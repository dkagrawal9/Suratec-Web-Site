						...
						<div class="col-lg-3 col-12">
							...
							<div class="services-sidebar">	
								...
								<div class="single-sidebar category">
									...
									<ul>
										<li class="active" ><a onclick="newPressure_Map()" id="pressure_map_btn"><i class="fa fa-list"></i> Pressure Map</a></li>  
...
function function_play() {
  ...
  datetimepicker =  $("#datetimepicker").val();  
  playback_time =  $("#playback_time").val();  
  $.redirect("playback_sport.php?id_customer="+id_customer, {playback_type: playback_type, datetimepicker: datetimepicker, playback_time: playback_time, status_play: '1'}, "POST", ""); 
}
