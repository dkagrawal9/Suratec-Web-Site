			...
			<section class="services single section">
				<div class="container">
                    ...
                    <li><a onclick="newDasboard()" ><i class="fa fa-globe"></i> Dasboard</a></li>   						
						...
						<div class="col-lg-9 col-12">
							...
							<div class="col-md-12" style="padding-top: 20px;">
								<p style="text-align: center;  font-size: x-large;">Time in Zone : <p id="p_time" style="text-align: center; font-size: x-large;"> 0 s </p></p>
                  ...
                  <div class="col-md-12" align="center" style="align-items: center;">
                    <canvas id="myCanvas_l" width="285" height="285" style="border:1px solid #d3d3d3; background-color: #353752;"></canvas>
                  </div>
                </div>
                ...
                <table class="table" border="1">
                    <tr>
                      <th style="background: #cccccc; text-align: center;">คะแนนการทรงตัวซ้าย</th>
                      <th style="background: #cccccc; text-align: center;">Balance Board Left</th>
                    </tr>
                    <tr>
				...
				<div class="col-md-6">
                  ...
                  <div class="col-md-12" align="center" style="align-items: center;">
                    <canvas id="myCanvas_r" width="285" height="285" style="border:1px solid #d3d3d3; background-color: #353752;"></canvas>
                  </div>
                  ...
                  <table class="table" border="1">
                    <tr>
                      ...
                      <th style="background: #cccccc; text-align: center;">คะแนนการทรงตัวขวา</th>
                      <th style="background: #cccccc; text-align: center;">Balance Board Right</th>
                    </tr>
                    <tr>
...
function function_play() {
  ...
  datetimepicker =  $("#datetimepicker").val();  
  playback_time =  $("#playback_time").val();  
  $.redirect("playback_sport_BB.php?id_customer="+id_customer, {playback_type: playback_type, datetimepicker: datetimepicker, playback_time: playback_time, status_play: '1'}, "POST", ""); 
}
