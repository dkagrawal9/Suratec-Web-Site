					...
					<div class="row">
						<div class="col-12">
							...
							<div class="bread-title">
								<h2>บทความ<!--Our Team--></h2>
							</div>
							<!-- Bread List -->
							<ul class="bread-list">
								<li><a href="./?index=st"><i class="fa fa-home"></i>หน้าแรก<!--Home--></a></li>
								<li class="active"><a href="article.php"><i class="fa fa-clone"></i> บทความ <!--Our Team--></a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							...
							<div class="single-blog">
								...
								<div class="blog-bottom">
									<h4><a href="./articledetail.php?id=<?=$data['id_article'];?>"><?=$data['name_article'];?></a></h4>
									<p><?=substr_replace($data['text'], '...' ,531);?></p>
									<ul class="blog-meta">
...
?>
													<?php } ?>									
										<li><a href="./articledetail.php?id=<?=$data['id_article'];?>"><i class="fa fa-comments"></i> <?=$rows;?> ความคิดเห็น</a></li>
									</ul>
								</div>
							</div>
							<!--/ End Single Blog -->
