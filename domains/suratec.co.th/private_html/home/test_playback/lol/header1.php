				...
				<div class="header-inner">
					<div class="container">
										...
										<div class="navbar-collapse">	
											<div class="nav-inner">	
												<ul class="nav main-menu navbar-nav"><!-- class="active" -->
													<li class="<?php if($_GET['index']=='st'){print 'active';}else{print '';} ?>"><a href="./?index=st"><?php echo $lang['MENU_HOME']; ?><!--หน้าแรก<!--Home--></a></li>
													<li class="<?php if($_GET['product_and_service']=='st'){print 'active';}else{print '';} ?>"><a href="./product_and_service.php?product_and_service=st"><?php echo $lang['MENU_PRODUCT_AND_SERVICE']; ?><!--สินค้าและบริการ<!--Product And Service--></a></li>
													<li class="<?php if($_GET['about_us']=='st'){print 'active';}else{print '';} ?>"><a href="./about_us.php?about_us=st"><?php echo $lang['MENU_ABOUT_US']; ?><!--เกี่ยวกับเรา<!--About Us--></a></li>
													<li class="<?php if($_GET['our_team']=='st'){print 'active';}else{print '';} ?>"><a href="./our_team.php?our_team=st"><?php echo $lang['MENU_our_team']; ?><!--ทีมงานของเรา<!--Our Team--></a></li>
													<li class="<?php if($_GET['shop']=='st'){print 'active';}else{print '';} ?>"><a href="#">สินค้า<?php// echo $lang['MENU_our_team']; ?><!--ทีมงานของเรา<!--Our Team--><i class="fa fa-angle-down"></i></a>
														<ul class="dropdown">
													...
													<li class="<?php if($_GET['contact_us']=='st'){print 'active';}else{print '';} ?>"><a href="./contact_us.php?contact_us=st"><?php echo $lang['MENU_contact_us']; ?><!--ติดต่อเรา<!--Contact Us--></a></li>
                        ...
                        print $resimgPro['img_path'];
													...
													<?php }else{ ?>
													<li class="<?php if($_GET['Signin_Signup']=='st'){print 'active';}else{print '';} ?>"><a href="./Signin_Signup.php?Signin_Signup=st"><?php echo $lang['MENU_Signin_Signup']; ?><!--เข้าสู่ระบบ / ลงทะเบียน<!--Login / Register--></a></li>
													<?php } ?>
