...
<section class="shop list section" style="padding: 40px 0 40px;">
	...
	<div class="row">
         	<div class="col-md-3">
						...
						<!-- <label for="location1"><?=$lang['MENU_category'];?></label> -->
						<select    id="inputGroupSelect00" onchange="search()" name="location">
			...
			<div class="col-md-3">
				<div class="input-group">
					<input type="text" id="inputGroupSelect02" class="form-control" onkeyup="search()"  placeholder="<?=$lang['MENU_search'];?>" aria-describedby="basic-addon2">
		...
		<div id="live_data-product-all" style="" align="center">
...
$(function () {
			...
			<?php echo 'document.getElementById("inputGroupSelect00").value  = ' . $searchgroup . ''; ?>;
                ...
                xmlhttp3.onreadystatechange = function () {
                    if (this.readyState == 4 && this.status == 200) {
                        document.getElementById("live_data-product-all").innerHTML = this.responseText;

                    }
                }
				xmlhttp3.open("GET", "live-data-product-all.php?&&searchall="+document.getElementById("inputGroupSelect02").value+"&&searchgroup="+ document.getElementById("inputGroupSelect00").value +"&&search=" + document.getElementById("inputGroupSelect01").value + "&&page=<?php echo $page  ?>", true);
                xmlhttp3.send();
            }
 );
 ...
 function search() {
                ...
                xmlhttp.open("GET", "live-data-product-search.php?&&searchall="+document.getElementById("inputGroupSelect02").value+"&&searchgroup="+ document.getElementById("inputGroupSelect00").value +"&&search=" + document.getElementById("inputGroupSelect01").value + "&&page=<?php echo $page  ?>", true);
                xmlhttp.send();
            }
...
function searchpage(page) {
                ...
                xmlhttp.open("GET", "live-data-product-search.php?&&searchall="+document.getElementById("inputGroupSelect02").value+"&&searchgroup="+ document.getElementById("inputGroupSelect00").value +"&&search=" + document.getElementById("inputGroupSelect01").value + "&&page="+page, true);
                xmlhttp.send();
            }
