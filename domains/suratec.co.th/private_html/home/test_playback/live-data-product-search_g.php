									...
									<div class="col-lg-4 col-md-6 col-12">
										...
										<div class="single-product">
											...
											<div class="product-meta">
												...
												<button onclick="add_Cart('<?=$objResult['id_product']; ?>','<?=$objResult['tmp_price']; ?>');" type="submit" class="btn"><i class="fa fa-shopping-basket"></i>เพิ่มใส่ตะกร้า<!--Add to cart--></button>
												<?php } else { ?>
												<button type="submit" id="check_lo" class="btn"><i class="fa fa-shopping-basket check_lo"></i>เพิ่มใส่ตะกร้า<!--Add to cart--></button>
												<?php } ?>
											</div>
											<!--/ End Product Meta -->
										</div>
