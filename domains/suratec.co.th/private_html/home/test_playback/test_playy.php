 ...
 <div class="box-header with-border">
                    ...
                    <legend style="width: auto; ">ค้นหา</legend>
                               ...
                               <div class="col-md-12">
                                ...
                                <button onclick=" myStopFunction()" type="button" class="btn btn-primary search_date" id="search_date"><span class="glyphicon glyphicon-search" aria-hidden="true"></span>&nbsp;<?=lang('ค้นหา', 'Search')?></button>&nbsp;&nbsp;&nbsp;
...
<div class="outsideWrapper">
    <div class="insideWrapper">
        <img src="../images/foot_right.png" style="max-width: 160;" class="coveredImage">/admin
...
iright=0;
  var setright = setInterval(function (ttr) {
     data_testright = playback_time_arr_left[iright];
