							...
							<div class="services-sidebar">	
								...
								<div class="single-sidebar category">
									...
									<ul>
										...
										<li class="active"><a href="playback_phy_GA.php"><i class="fa fa-handshake-o"></i>Gait Analysis</a></li>			
...
<!-- Create a div where the graph will take place -->
						<i class="fa fa-info-circle" style="color: #0998CC"></i> พื้นรองเท้าด้านซ้าย<!--Insoles left-->
							<div id="chart_left"></div>
						</div>	
						<div class="col-lg-6 col-12">
<!-- Create a div where the graph will take place -->
						<i class="fa fa-info-circle" style="color: #0998CC"></i> พื้นรองเท้าด้านขวา<!--Insoles right-->
