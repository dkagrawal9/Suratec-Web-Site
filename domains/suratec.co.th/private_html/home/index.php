				...
				<div class="container">
					...
					<div class="row">
												...
												if($lang_file == 'lang.th.php'){
													...
													echo htmlspecialchars_decode($name_text);
												}
												 else{
													 $name_text_en = $resultoffice['text_en'];
													echo htmlspecialchars_decode($name_text_en);
												 }
												?>
...
?>
									<div class="single-blog">
										<div class="blog-head">
											...
											<a href="./articledetail.php?id=<?=$new['id_article'];?>"><img src="../uploads/mod_article/<?=$new['image'];?>" alt="#"></a>
										</div>
										<div class="blog-bottom">
											...
											<p>
												<?php
												if($lang_file == 'lang.th.php'){
													$name_text = substr_replace($new['text'], '...' ,531);
													echo $name_text;
												}
												 else{
													 $name_text_en = substr_replace($new['text_en'], '...' ,531);
													echo $name_text_en;
												 }
												?>
											</p>
											<ul class="blog-meta">
												...
												<?php
		 										if($lang_file == 'lang.th.php'){
													$name_text = DateThai($new['create_datetime']);
													echo $name_text;
												}
												 else{
													 $name_text_en = DateEng($new['create_datetime']);
													echo $name_text_en;
												 }
												?></li>
                                    ...
                                    ?>" alt="#"><span>By : <!--<a href="#">--><?=$lang['MENU_n_s']?><!--</a>--></span></li>
...
?>
									<div class="single-blog">
										<div class="blog-head">
											<!--<div class="date">15<span>Jun</span></div>-->
											<a href="./newsdetail.php?id=<?=$new['id_article'];?>"><img src="../uploads/mod_article/<?=$new['image'];?>" alt="#"></a>
										</div>
										<div class="blog-bottom">
						...
						<div class="col-lg-6 col-12">
							<div class="faqs-main">
								...
								<div class="faq-area">
<?php
	$sqlq = "SELECT `id`, `question`, `question_en`, `answer`, `answer_en` FROM `faq` WHERE `del_flg` = '0' ORDER BY `order` ASC LIMIT 5";
