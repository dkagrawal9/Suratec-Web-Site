                                        ...
                                        <div class="navbar-collapse">	
                                            <div class="nav-inner">	
                                                <ul class="nav main-menu navbar-nav"><!-- class="active" -->
                                                    ...
                                                    ?>"><a href="./?index=st"><?php echo $lang['MENU_HOME']; ?><!--หน้าแรก<!--Home--></a></li>
                                                    <li class="<?php
                                                    ...
                                                    ?>"><a href="./product_and_service.php?product_and_service=st"><?php echo $lang['MENU_PRODUCT_AND_SERVICE']; ?><!--สินค้าและบริการ<!--Product And Service--></a></li>
                                                    <!--<li class="<?php/*
                                                    if ($_GET['about_us'] == 'st') {
                                                        print 'active';
                                                    } else {
                                                    ...
                                                    ?>"><a href="./about_us.php?about_us=st"><?php// echo $lang['MENU_ABOUT_US']; ?><!--เกี่ยวกับเรา<!--About Us --</a></li>-->
                                                    <li class="<?php
                                                    if ($_GET['our_team'] == 'st') {
                                                        print 'active';
                                                    } else {
                                                    ...
                                                    ?>"><a href="./our_team.php?our_team=st"><?php echo $lang['MENU_our_team']; ?><!--ทีมงานของเรา<!--Our Team--></a></li>
                                                    ...
                                                    ?>"><a href="#"><?php  echo $lang['MENU_Shoppng'];  ?><!--ทีมงานของเรา<!--Our Team--><i class="fa fa-angle-down"></i></a>
                                                        <ul class="dropdown">
                                                            <li><a href="shop-list.php?shop_m=st"><span><i class="fa fa-shopping-bag"></i> <?php  echo $lang['MENU_Shop']; ?><!--Profile--></span> </a></li>
                                                            <!--<li><a href="shop-grid.php?shop_m=st">สินค้าแบบตะแกรง<?php // echo $lang['MENU_Playback_S'];         ?></a></li>-->
                                                            <li><a href="cart.php?shop_m=st"><i class="fa fa-shopping-cart"></i> <?php  echo $lang['MENU_Shop_cart'];           ?></a></li>
                                                            <li><a href="checkout.php?shop_m=st"><i class="fa fa-money"></i> <?php  echo $lang['MENU_Payment_M'];         ?></a></li>
                                                        </ul>
                                                    </li>
                                                    <li class="<?php
                                                    ...
                                                    ?>"><a href="./contact_us.php?contact_us=st"><?php echo $lang['MENU_ABOUT_US']; ?> <i class="fa fa-angle-down"></i><!--ติดต่อเรา<!--Contact Us--></a>
														<ul class="dropdown">
															<li><a href="./about_us.php?contact_us=st"><?php echo $lang['MENU_ABOUT_US']; ?></a></li>
                                                            <li><a href="./contact_us.php?contact_us=st"><span><?php echo $lang['MENU_contact_us']; ?><!--Profile--></span> </a></li>
                                                        </ul>
													</li>
                                                        ...
                                                        if ($resimgPro['id_facebook'] != '' || $resimgPro['id_google'] != '' ) {
                                                            ...
                                                            print "https://api1.suratec.co.th/pic/" . $resimgPro['img_path'];
                                                        }
                                                        ...
                                                        ?>"><a href="#"><?php
                                                            ...
                                                            <ul class="dropdown">
                                                                <li><a href="../playback/playback_phy.php?profile=st">
                                                                        <?php echo $lang['MENU_data_playback_system'] ?>
                                                                        <img  style="width: 14px;height: 14px;float: right;" src="../images/replay.png">
                                                                        
                                                                    </a>
                                                                </li>
																<li><a href="./profile_history.php?profile=st"><i class="icofont icofont-history"></i><span> <?php echo $lang['MENU_Order_history']?><!--Profile--></span> </a></li>
                                                                <li class="dropdown-submenu">
                                                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icofont icofont-doctor"></i>Telemedicine</a>
                                                                    <ul class="dropdown-menu" style="padding:0px">
                                                                        <li><a class="dropdown-item" href="./appointments.php?profile=st"><i class="fa fa-calendar"></i><span> <?php echo $lang['MENU_Appointments']?><!--Appointment--></span> </a></li>
                                                                        <li><a class="dropdown-item" href="./doctors.php?profile=st"><i class="fa fa-users"></i><span> <?php echo $lang['MENU_Doctors']?><!--Appointment--></span> </a></li>
																        <li><a class="dropdown-item" href="./notifications.php?profile=st"><i class="fa fa-bell"></i><span> <?php echo $lang['MENU_Notifications']?><span id="notification-count">&nbsp;(<span><?php echo $notificationCount ?></span>)</span></span> </a></li>
                                                                    </ul>
                                                                </li>
                                                    ...
                                                    <?php } else { ?>
                                                        ...
                                                        ?>"><a href="./Signin_Signup.php?Signin_Signup=st"><?php echo $lang['MENU_Signin_Signup']; ?><!-- id="check_lo" เข้าสู่ระบบ / ลงทะเบียน<!--Login / Register--></a></li>
                                                        <?php } ?>
