...
<!-- shopping cart-->
            ...
            if (isset($_POST['code']) && $_POST['code'] != "") {
                $code = $_POST['code'];
                $result = mysqli_query($objConnect, "SELECT * FROM `product` LEFT JOIN product_image ON product.id_product = product_image.id_product WHERE product.id_product ='$code'");
                                        ...
                                        <div class="navbar-collapse">	
                                            <div class="nav-inner">	
                                                <ul class="nav main-menu navbar-nav"><!-- class="active" -->
                                                    ...
                                                    ?>"><a href="#">สินค้า<?php // echo $lang['MENU_our_team'];  ?><!--ทีมงานของเรา<!--Our Team--><i class="fa fa-angle-down"></i></a>
                                                        <ul class="dropdown">
                                                            <li><a href="./shop-list.php?shop=st"><span> สินค้ารายการ<?php // echo $lang['MENU_Profile'];          ?><!--Profile--></span> </a></li>
                                                            <li><a href="./shop-grid.php?shop=st">สินค้าตะแกรง<?php // echo $lang['MENU_Playback_S'];         ?></a></li>
                                                            <li><a href="./cart.php?shop=st">รถเข็น<?php // echo $lang['MENU_Playback_S'];           ?></a></li>
                                                            <li><a href="./checkout.php?shop=st">ชำระเงิน<?php // echo $lang['MENU_Playback_S'];         ?></a></li>
                                                        </ul>
                                                    </li>
                                                    <li class="<?php
                                                    ...
                                                    ?>"><a href="./contact_us.php?contact_us=st"><?php echo $lang['MENU_contact_us']; ?><!--ติดต่อเรา<!--Contact Us--></a></li>
                                                        <?php if (isset($_SESSION["id_customer"])) { ?>
                                                        <img src="<?php
                                                        if ($resimgPro['id_facebook'] != '') {
                                                    ...
                                                    <?php } else { ?>
                                                        ...
                                                        ?>"><a href="./Signin_Signup.php?Signin_Signup=st"><?php echo $lang['MENU_Signin_Signup']; ?><!--เข้าสู่ระบบ / ลงทะเบียน<!--Login / Register--></a></li>
                                                        <?php } ?>
                                                ...
                                                <div class="right-bar">
                                                    ...
                                                    <div class="single-bar shopping">
                                                        ...
                                                        <div class="shopping-item">
                                                            <ul class="shopping-list">
                                                                ...
                                                                foreach ($_SESSION["shopping_cart"] as $product) {
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <a class="cart-img" href="#"><img src="../uploads/product/<?php echo $product['image']; ?>" alt="#"></a>
                                                                        <h4><a href="#"><?php echo $product["name"]; ?></a></h4>
                                                                        <p class="quantity"><?php echo $product["quantity"]; ?>x - <span class="amount">$<?php echo $product["price"]; ?></span></p>
                                                                    </li>
                                                                    <?php
                                                            ...
                                                            <div class="bottom">
                                                                <p class="total">Total Amount:<span><?php echo "$" . $total_price2; ?></span></p>
                                                                <a href="http://localhost/suratec_m/home/cart.php" class="btn animate">Checkout</a>
                                                            </div>
                                                        </div>
                                                        <!--/ End Shopping Item -->
                                                        <a class="icon"><i class="fa fa-shopping-basket"></i><span class="count"><?= $product_count_cart ?></span></a>
                                                    </div>
                                                    <!--/ End Shopping Cart -->
