					...
					<div class="row">
						<div class="col-12">
							...
							<ul class="bread-list">
								...
								<li class="active"><a href="data_protection_policy.php?data_protection_policy=st"><i class="fa fa-clone"></i><?php
												if($lang_file == 'lang.th.php'){
													$name_text = $result13['name_page'];
													echo $name_text;
												}
						...
						<div class="col-lg-12 col-md-6 col-12">
							...
							<div class="single-service">
								...
								<p>
												<?php
												if($lang_file == 'lang.th.php'){
													$name_text = $result13['text'];
													echo $name_text;
												}
												 else{
													 $name_text_en = $result13['text_en'];
													echo $name_text_en;
												 }
												?>
								</p>
