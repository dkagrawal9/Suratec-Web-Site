                                            ...
                                            <div class="nav-inner">	
                                                <ul class="nav main-menu navbar-nav"><!-- class="active" -->
                                                    ...
                                                    ?>"><a href="#">สินค้า<?php // echo $lang['MENU_our_team'];  ?><!--ทีมงานของเรา<!--Our Team--><i class="fa fa-angle-down"></i></a>
                                                        <ul class="dropdown">
                                                            <li><a href="shop-list.php?shop_m=st"><span> สินค้ารายการ<?php // echo $lang['MENU_Profile'];          ?><!--Profile--></span> </a></li>
                                                            <li><a href="shop-grid.php?shop_m=st">สินค้าตะแกรง<?php // echo $lang['MENU_Playback_S'];         ?></a></li>
                                                            <li><a href="cart.php?shop_m=st">รถเข็น<?php // echo $lang['MENU_Playback_S'];           ?></a></li>
                                                            <li><a href="checkout.php?shop_m=st">ชำระเงิน<?php // echo $lang['MENU_Playback_S'];         ?></a></li>
                                                        </ul>
                                                    </li>
                                                    <li class="<?php
...
<li><a href="contact.html">Contact</a></li>-->					
                                                ...
                                                <div class="right-bar">
                                                    ...
                                                    <div class="single-bar shopping">
                                                        ...
                                                        <!-- Shopping Item -->
														<a class="icon"><i class="fa fa-shopping-basket"></i><span class="count" id="qtyproductmain">0</span></a>
                                                        <!-- Shopping Cart -->
                                                        ...
                                                        <div class="shopping-item">
                                                            ...
                                                            <div class="bottom">
                                                                <p class="total">ยอดรวม :<span id="qtyprice"> </span></p>
                                                                <a href="cart.php?shop_m=st" class="btn animate">Checkout</a>
                                                            </div>
                                                        </div>
                                                        <!--/ End Shopping Item -->
                                                    </div>
...
<li><a href="#"><i class="icofont icofont-social-dribbble"></i></a></li>-->
  ...
  window.onload = function() {
	myVar = setInterval(myTimer_cart ,1000)
