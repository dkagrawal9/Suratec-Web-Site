  ...
  <div class="navbar-fixed">
    <nav class="agora-navbar">
      <div class="nav-wrapper agora-primary-bg valign-wrapper">
        <h5 class="left-align">Appointment</h5>
        <button class="btn btn-raised btn-primary waves-effect waves-light float-right" id="leave">LEAVE</button>
      </div>
    </nav>
  </div>
        ...
        <div class="card" style="margin-top: 0px; margin-bottom: 0px;">
          <div class="row card-content" style="margin-bottom: 0px;">
              <div class="input-field">
                ...
                <input type="text" placeholder="App ID" name="appID" value="427de33581664f158e837109a11077db">
              </div>
              <div class="input-field">
                <label for="channel" class="active">Channel</label>
                <input type="text" placeholder="channel" name="channel" value="my-channel">
              </div>
              <div class="input-field">
