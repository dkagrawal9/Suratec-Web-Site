...
class SurasoleController extends Controller
{
    ...
    public function updatesurasolesensor(Request $request)
    {
        ...
        $left_sensor5 = trim($request->left_sensor5);
          // 12-09-2021 add by Deepak
        $left_sensor6 = trim($request->left_sensor6);
        $left_sensor7 = trim($request->left_sensor7);
        $left_sensor8 = trim($request->left_sensor8);
        ...
        $right_sensor5 = trim($request->right_sensor5);
          // 12-09-2021 add by Deepak
        $right_sensor6 = trim($request->right_sensor6);
        $right_sensor7 = trim($request->right_sensor7);
        $right_sensor8 = trim($request->right_sensor8);
        if ($customer) {
            $surasole = Surasole::where('id_customer', $customer->id_customer)->first();
            ...
            $surasole->left_sensor5 = $left_sensor5;
              // 12-09-2021 add by Deepak
            $surasole->left_sensor6 = $left_sensor6;
            $surasole->left_sensor7 = $left_sensor7;
            $surasole->left_sensor8 = $left_sensor8;
            ...
            $surasole->right_sensor5 = $right_sensor5;
              // 12-09-2021 add by Deepak
            $surasole->right_sensor6 = $right_sensor6;
            $surasole->right_sensor7 = $right_sensor7;
            $surasole->right_sensor8 = $right_sensor8;
        ...
        if ($customer) {
            try {
                for ($i = 0; $i < count($req['data']); $i++) {
                    ...
                    // 12-09-2021 add by Deepak
                    $res[$side . '_sensor6'] = isset($dataLeft[$side . '_sensor6'])?$dataLeft[$side . '_sensor6']:0;
                    $res[$side . '_sensor7'] = isset($dataLeft[$side . '_sensor7'])?$dataLeft[$side . '_sensor7']:0;
                    $res[$side . '_sensor8'] = isset($dataLeft[$side . '_sensor8'])?$dataLeft[$side . '_sensor8']:0;
                    ...
                    // 12-09-2021 add by Deepak
                    $res[$side . '_sensor6'] = isset($dataRight[$side . '_sensor6'])?$dataRight[$side . '_sensor6']:0;
                    $res[$side . '_sensor7'] = isset($dataRight[$side . '_sensor7'])?$dataRight[$side . '_sensor7']:0;
                    $res[$side . '_sensor8'] = isset($dataRight[$side . '_sensor8'])?$dataRight[$side . '_sensor8']:0;
                    ...
                    $res['type'] = $req['type'];
                    // 12-09-2021 add by Deepak
                    $res['product_number'] = isset($req['product_number'])?$req['product_number']:0;
                    $res['bluetooth_left_id'] = isset($req['bluetooth_left_id'])?$req['bluetooth_left_id']:0;
                    $res['bluetooth_right_id'] = isset($req['bluetooth_right_id'])?$req['bluetooth_right_id']:0;
                    $res->save();
                }
                DB::commit();
