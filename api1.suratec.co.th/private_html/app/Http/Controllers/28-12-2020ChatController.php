...
class ChatController extends Controller
{
    ...
    */
    ...
    public function getPatientList($id){
       return Customer::select('id_customer','id_customer as id','fname','lname','chat_status.status as chat_status')
    ...
    public function getDoctorList($id){
       return Employee::select('id_employee','id_employee as id','surname as lname','username as fname','chat_status.status as chat_status')
