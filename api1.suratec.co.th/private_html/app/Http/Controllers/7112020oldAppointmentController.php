    ...
    public function create(Request $request)
    {
        ...
        if ($appointment->save()) {
            if($request->data_role == "mod_employee"){
                ...
                if($getCustomer){
                   $this->sendNotification($getCustomer->device_type,$title="Appointment",$msg="Appointment create by $empname",$getCustomer->device_id,$appointment);
                ...
                if($getCustomer){
                    $this->sendNotification($getCustomer->device_type,$title="Appointment",$msg="Appointment create by $custname",$getCustomer->device_id,$appointment);
    ...
    public function cancelAppointment($id_appointment = '', $id_customer ='',$status ='')
    {
        ...
        if ($appointment->save()) {
            ...
            if($status == "6"){
                ...
                if($getCustomer){
                   $this->sendNotification($getCustomer->device_type,$title="Appointment",$msg="Appointment reject  by $name",$getCustomer->device_id,$appointment);
                ...
                if($getCustomer){
                   $this->sendNotification($getCustomer->device_type,$title="Appointment",$msg="Appointment approve by $name",$getCustomer->device_id,$appointment);
                ...
                if($getCustomer){
                    $this->sendNotification($getCustomer->device_type,$title="Appointment",$msg="Appointment cancel by $name",$getCustomer->device_id,$appointment);
            ...
            if($status == "5"){
            return response()->json(['status' => 'OK', 'message' => 'Appointment Aprrove successfully'], 200);
            }
            if($status == "2"){
